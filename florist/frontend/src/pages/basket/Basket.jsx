        ...
        <tbody>
          {
            allbasket.map((basket) => (
              <tr key={basket._id}>
                ...
                <td>
                  <div className="count">
                    <Button variant="outline-success" onClick={()=>dispatch(decrement(basket._id))}>-</Button>
                    <p>{basket.count}</p>
                    <Button variant="outline-success" onClick={()=>dispatch(increment(basket._id))}>+</Button>
                  </div>
                </td>
                <td>
